...
class TatuReq:
    def __init__(self, method, device, sensor=None, collect=None, publish=None, delta=None,sample=None,messageId=None, messageTimeStamp=None):
    ...
    def getTatu(self):
        ...
        if(self.messageTimeStamp!=None):
            msg["messageTimeStamp"] = self.messageTimeStamp
...
class TatuRes:
    def __init__(self, method, device, sensor=None, collect=None, publish=None,
                 sample=None, sensorsList=None, sensorsValue=None, messageId=None, messageTimeStamp=None):
        self.method = method.lower()
        self.device = device
        self.sensor = sensor if sensor else None
        self.collect = str(collect)
    ...
    def getTatu(self):
        ...
        if(self.messageTimeStamp!=None):
            header["messageTimeStamp"]=self.messageTimeStamp
